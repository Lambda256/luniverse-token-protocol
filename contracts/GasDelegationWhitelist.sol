...
contract GasDelegationWhitelist is WhitelistAdminRole {
     ...
     *
     ****************************************************************************************************/
    address private constant Miner = 0x00000000000000000000000000000000000003E7;
    ...
    uint256 private constant GasAllocationMax = 10 ether;
    uint256 private constant DailyGasAllocation = 1 ether;
    uint256 private constant GasRefillTimeInterval = 24 hours;
     ...
     *
     ****************************************************************************************************/
    event FundOwnerChanged(
        address indexed oldFundOwner,
        address indexed newFundOwner
    );
    ...
    function checkWhitelist(address _addr, uint256 _gas)
    public
    view
    returns (bool)
    {
     ...
     *
     ****************************************************************************************************/
    function refundAll() public onlyFundOwner returns (bool) {
        _fundOwner.transfer(address(this).balance);
        return true;
    }

    function refundAmount(uint256 amount) public onlyFundOwner returns (bool) {
    ...
    function setFundOwner(address payable newFundOwnerAddress)
    external
    onlyFundOwner
    returns (bool)
    {
    ...
    function substituteWhitelistEntry(
        address _oldAddr,
        address _newAddr,
        uint256 _gasAlloc /* V2
     feature */
    ...
    function removeWhitelistEntry(address _addr) public onlyWhitelistAdmin {
        require(_addr != address(0));
    ...
    function addSuperWhitelistEntry(address addr)
    external
    onlyWhitelistAdmin
    returns (bool)
    {
    ...
    function removeSuperWhitelistEntry(address addr)
    external
    onlyWhitelistAdmin
    returns (bool)
    {
